<!-- Add Staff Modal -->
<div class="modal fade" id="addstaffModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="addstaffModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <div class="header-title">
            <h4 class="modal-title" id="addstaffModalLabel"><strong>ADD ACADEMIC STAFF</strong></h4>
        </div>
      ...
      <div class="modal-body">
        <form id="add_staff_form" name="add_staff_form" class="form-row" action="<?= ROOT ?>includes/add_staff.inc.php" method="POST" onsubmit="return checkStaff();">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="usertype" class="form-control" id="usertype" value="STAFF" readonly>
                <i class="las la-check-circle"></i>
                <i class="las la-exclamation-circle"></i>
                <small>Error Message</small>
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <?php
                        echo "<select name='designation' class='form-control' id='designation'>";; 
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" name="field_category" class="form-control" id="field_category" placeholder="Field Category">
                <i class="las la-check-circle"></i>
                <i class="las la-exclamation-circle"></i>
                <small>Error Message</small>
            </div>
            <div class="form-group col-md-12">
                ...
                <input type="text" name="field" class="form-control" id="field" placeholder="Field">
                <i class="las la-check-circle"></i>
                <i class="las la-exclamation-circle"></i>
                <small>Error Message</small>
            </div>
