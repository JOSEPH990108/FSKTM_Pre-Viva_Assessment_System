...
<div class="main-content" onclick="removeToggle();">
    ...
    <div class="ibox-content">
        <div class="table-responsive">
            <table class="table table-striped table-bordered dataTables-example" style="width: 100%">
                <thead>
                    <tr>
                        <th>Actions</th>
                        <th>User ID</th>
                ...
                if(!mysqli_stmt_prepare($stmt, $sql)){
                    ...
                    <tr>
                        <td>
                            ...
                            <button class="btn btn-success staff_editbtn" id="staff_editbtn" data-toggle="modal" data-target="#editstaffModal"><i class="fa fa-cog" aria-hidden="true"></i></button>
                            <button class="btn btn-danger staff_deletebtn" id="staff_deletebtn" ><i class="fa fa-times" aria-hidden="true"></i></button>
                            </div>
                        </td>
                        <td><?=$user_id?></td>
                        <td><?=$name?></td>
...
<!-- Include Modal -->
<?php
    include('modal/add_staff_modal.php');
    include('modal/edit_staff_modal.php');
?>
